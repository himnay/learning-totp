...
public record GenerateRecoveryCodesRequest(
    @Schema(description = "Device id an enrolled TOTP secret already exists for", example = "alice-iphone-15")
        @NotBlank(message = "deviceId must not be blank")
        String deviceId,
    @Schema(description = "How many codes to generate — replaces any previously issued codes for this device", example = "10", defaultValue = "10")
