...
public record GenerateTotpResponse(
    ...
    @Schema(description = "Base32-encoded shared secret, also persisted server-side against deviceId", example = "JBSWY3DPEHPK3PXP")
        String secret,
    @Schema(
            description = "otpauth:// provisioning URI, as encoded into the QR code",
            example = "otpauth://totp/learning-totp:alice-iphone-15?secret=JBSWY3DPEHPK3PXP&issuer=learning-totp&algorithm=SHA1&digits=6&period=30")
        String otpAuthUri,
